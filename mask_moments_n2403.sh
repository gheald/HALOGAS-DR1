...
for f in `ls MOMENTS/*2403*nrch.fits | awk '{split($0,a,"_");print a[1]}'`; do
	echo $f
	...
	###
	# For NGC 2403 only
	puthd in=mom0mskz/ctype3 value=VELO-HEL
	puthd in=mom0mskz/crval3 value=0.0
	puthd in=mom0mskz/crpix3 value=1
	puthd in=mom0mskz/naxis3 value=1
	puthd in=mom0mskz/naxis value=3
	# End block for NGC 2403
	###
	linmos in=mom0mskz out=mom0mskzlm
	###
	# For NGC 2403 only
	delhd in=mom0mskz/ctype3
	delhd in=mom0mskz/crval3
	delhd in=mom0mskz/crpix3
	delhd in=mom0mskz/naxis3
	puthd in=mom0mskz/naxis value=2
	delhd in=mom0mskzlm/ctype3
	delhd in=mom0mskzlm/crval3
	delhd in=mom0mskzlm/crpix3
	delhd in=mom0mskzlm/naxis3
	puthd in=mom0mskzlm/naxis value=2
	# End block for NGC 2403
	###
